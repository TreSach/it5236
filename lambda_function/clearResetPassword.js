		...
		console.log("Connected!");
		  	...
		  	if (err) {
				...
				callback(formatErrorResponse('INTERNAL_SERVER_ERROR', [err]));
		  			...
		  			errors.push("No password found for " + event.passwordresetid);
		  			callback(formatErrorResponse('BAD_REQUEST', [err]));
		  		} else {
		  		
					console.log("Clearing password reset for " + event.passwordresetid);
					callback(null, "clear password reset successfully");
					conn.end();
				} //good code count
